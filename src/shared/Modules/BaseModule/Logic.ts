...
export default class Logic extends BaseModule {
    private readonly program: LogicNode[]

    constructor(program: LogicNode[]) {
        super();
    ...
    // TODO: Implement handler-based logic (see notes)
}
